...
if file is not None:
    ...
    for page in pdf_reader.pages:
        ...
        #st.write("Extract the text ==>"+text)
...
#Break it into chunks
    ...
    #st.write("Break it into chunks => " + str(chunks))
    ...
    if user_question:
        ...
        llm = ChatOpenAI(
            ...
            temperature=0, #specific and non-random
            max_tokens=1000,
...
#who can be president of India? format in bullet points
